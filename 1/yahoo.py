...
def crawler(keyword):
    ...
    headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3495.100 Safari/537.36 OPR/56.0.3041.43'}

    res=requests.get("https://tw.search.yahoo.com/search?p="+keyword,headers=headers)
    # res = requests.get("https://tw.search.yahoo.com/search;_ylt=AwrtEFhPdNNbChAA28Nr1gt.;_ylu=X3oDMTFhdTV0M3ZoBGNvbG8DdHcxBHBvcwMxBHZ0aWQDQjU1MTlfMQRzZWMDcGFnaW5hdGlvbg--?p=searchengine&pz=14&bct=0&b=1&pz=10&bct=0&xargs=0")
